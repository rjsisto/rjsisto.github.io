...
The Prodigee cases are the most profitable cases sold for any phone, let alone Apple, with an average profit of \\$31.16 on each case sold. The Zagg cases come in a close second with an average profitability of \\$30.03. Zagg is also the second-best selling case after OtterBox, selling 123 cases to OtterBox’s 249 cases in 2023. CaseMate, which sits just below OtterBox in terms of profitability, sold the third most cases for iPhones, with 88 sold.
...
The easiest way to increase profits from case sales is to recommend cases that sell for more profit per unit sold. Taking the top two best-selling case brands for iPhones, OtterBox and Zagg, we can see the real benefits for recommending certain case brands over others. An extra \\$7.46 is made per Zagg case than an OtterBox case. If those 100 iPhone customers were to buy Zagg instead of OtterBox cases, that would be an extra \\$743 of total profit made. That’s only just more money for the company, that’s more money for the associates as well, as each associate would make an extra \\$1.49 per case sale.

Now some customers will only buy a particular case brand, but many customers do ask associates for recommendations or advice on a case. This is where customers can be swayed to go for more high profit case brands. Most customers do not need the protection that OtterBox cases provide and this is where associates can steer customers towards case brands that will still provide excellent protection for their phones, but also make more money for the company and the associate.
